...
*/
    ...
    function aru(index){
      return "<img class='emoji aru' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0https://cdn.jsdelivr.net/gh/CL0610/codercc-cdn@1.3/img/aru/" + index + ".png'>";
    }
    function tieba(str){
      return "<img class='emoji tieba' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0https://cdn.jsdelivr.net/gh/CL0610/codercc-cdn@1.3/img/tieba/" + str + ".png'>";
    }
    function qq(str) {
      return "<img class='emoji qq' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0https://cdn.jsdelivr.net/gh/CL0610/codercc-cdn@1.3/img/qq/" + str + ".gif'>";
    }
		e.exports = {
      aru151: aru(151),
      贴吧what: tieba('what'),
